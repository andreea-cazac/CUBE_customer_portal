...
//     return {
//       profile: {},
//       apiKey: 'AIzaSyCb-VXv9duPI7zRwSm_nu-_KUbHUrnV23A',
//     };
//   },
//   async created() {
//     try {
//       // const responseRelations = await axios.get('https://apim-solidpartners-p.azure-api.net/cp-cube-mock/cp/relations/1');
//       const responseRelations = axios.get(`https://cube-testing.solidpartners.nl/cp/relations/${this.relationId}`, {
//         headers: {
//           'Authorization': 'Bearer ' + useUserStore().token,
//           'Access-Control-Allow-Origin':  'http://localhost:5173'
//         }
//       })
//       profile = responseRelations.data;
